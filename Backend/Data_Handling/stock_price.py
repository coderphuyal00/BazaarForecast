...
#     from API.serializers import stockpriceSerializer
#     url=f'https://raw.githubusercontent.com/Aabishkar2/nepse-data/refs/heads/main/data/company-wise/{ticker}.csv'
#     # response=requests.get(url)
#     df=pd.read_csv(url)
#     last_tuple = df.iloc[-1]
#     data=last_tuple.to_dict()
#     required_data={
#             'published_date':last_tuple['published_date'],
#             'close_price':last_tuple['close'],
#             'status':last_tuple['status'],
#         }
#     serializer = stockpriceSerializer(instance=data)
